...
- Game dev · AI tools · experiments
- At the end of IT studies (BEng (Poly), IT)
- Looking for opportunities

[Full portfolio site →](https://zaapaa.github.io)
...
<table style="width: 100%;">
  <!-- Idea Pipeline -->
  <tr>
    <td style="width: 85%; padding: 1em;">
      <h4>Idea Pipeline — skill + gallery</h4>
      <p><b>Who:</b> Solo project<br>
        <b>What:</b> An agent skill that runs a three-stage idea factory: research subagents → verified specs → built single-page web apps. The companion gallery holds the <b>112 ideas it has built</b> — tiny games, 3D visualizations and useful one-pagers, each a self-contained static HTML page with its spec and a screenshot of proof.<br>
        <b>Role/skills:</b> Agent skill design, prompt/spec writing, HTML/JS, verification loops</p>
        <a href="https://zaapaa.github.io/idea-pipeline-examples/">Play the 112 ideas</a><br><br>
        <a href="https://github.com/zaapaa/idea-pipeline-skill">The skill</a> ·
        <a href="https://github.com/zaapaa/idea-pipeline-examples">The gallery</a>
    </td>
    <td style="width: 15%; padding: 1em;"></td>
  </tr>

  <!-- Meme Carver (Web) -->
  <tr>
    <td style="width: 85%; padding: 1em;">
      <h4>Meme Carver (Web)</h4>
      <p><b>Who:</b> Solo project<br>
        <b>What:</b> Content-aware seam-carving meme generator running entirely in your browser. No uploads, no servers, one file — drop an image (animated GIFs welcome), carve it, and export GIF / WebP / APNG, or squeeze an optimized size-limited GIF with live preview. Faithful port of the <a href="https://github.com/zaapaa/meme_carver">original Python/Tkinter tool</a>, reimplemented from scratch in vanilla JS with Web Workers.<br>
        <b>Role/skills:</b> JavaScript, image processing, Web Workers, OffscreenCanvas, GIF codec</p>
        <a href="https://zaapaa.github.io/meme_carver_web/">Try it in your browser</a><br><br>
        <a href="https://github.com/zaapaa/meme_carver_web">Web source</a> ·
        <a href="https://github.com/zaapaa/meme_carver">Original (Python)</a>
    </td>
    <td style="width: 15%; padding: 1em;"></td>
  </tr>
...
<table style="width: 100%;">
  ...
  <tr>
    <td style="width: 75%; padding: 1em;">
      <h4>Tiny Tongue</h4>
      <p><b>Who:</b> Game project in school, team of around 8 members<br>
  ...
  <tr>
    <td style="width: 75%; padding: 1em;">
      <h4>LaserGrid</h4>
      <p><b>Who:</b> Game project in school, team of around 6 members<br>
  ...
  <tr>
    <td style="width: 75%; padding: 1em;">
      <h4>Sneek</h4>
      <p><b>Who:</b> just me, still working on it sometimes<br>
  ...
  <tr>
    <td style="width: 75%; padding: 1em;">
      ...
      <p><b>Who:</b> just me, planning to work on it again in the future<br>
  ...
  <tr>
    <td style="width: 75%; padding: 1em;">
      ...
      <p><b>Who:</b> Hobby project, its dead, team size varied from 2 to 10 members<br>
  ...
  <tr>
    <td style="width: 75%; padding: 1em;">
      ...
      <p><b>Who:</b> just me, updating it whenever needed<br>
  ...
  <tr>
    <td style="width: 75%; padding: 1em;">
      <h4>AI things</h4>
      <p><b>Who:</b> just me, personal hobby, playing around with it actively<br>
        ...
        <b>Role/skills:</b> python, problem solving, AI<br>
        <b>Image:</b> a custom <img src="https://github.com/zaapaa/zaapaa/assets/24585685/3ee18c4b-ae27-43d7-8654-395f2b792322"> sofa (ez-sofa) by Stable Diffusion</p>
    </td>
    <td style="width: 25%; padding: 1em;">
